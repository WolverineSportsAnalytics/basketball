...
if __name__ == "__main__":
    ...
    ridge = Ridge(alpha=2.9, fit_intercept=True, normalize=True)
    ...
    ridge = Ridge(alpha=10.6, fit_intercept=True, normalize=True)
    ...
    ridge = Ridge(alpha=5.9, fit_intercept=True, normalize=True)
    ridge.fit(testXL, testY)
    thetaSKLearnRidge = ridge.coef_
