...
def train_model():
    ...
    features, response = pca_step1_modelworkflow.split_features(features, np.linspace(0, 450, dtype=int, num=450)); #456 relevant features after removal of fanduel and draftkings
    ...
    model = MLPRegressor(hidden_layer_sizes = (50, ), alpha = 100.0, activation = 'relu', learning_rate = 'adaptive', solver = 'sgd', max_iter = 200);
