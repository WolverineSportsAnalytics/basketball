...
def train_model():
    ...
    features, response = pca_step1_modelworkflow.split_features(features, np.linspace(0, 450, dtype=int, num=451)); #456 relevant features after removal of fanduel and draftkings
