...
def train_model():
    ...
    features, response = pca_step1_modelworkflow.split_features(features, np.linspace(0, 455, dtype=int, num=455)); #456 relevant features after removal of fanduel and draftkings
